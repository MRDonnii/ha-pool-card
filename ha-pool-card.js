...
class HAPoolCard extends HTMLElement {
  ...
  static getStubConfig() {
    return {
      ...
      camera_entity: "camera.terrasse_syd_medium_resolution_channel",
      person_in_water_entity: "binary_sensor.pool_person_i_vandet",
      person_terrace_entity: "binary_sensor.terrasse_syd_person_detected",
      ...
      power_entity: "sensor.terrassen_pool_power",
